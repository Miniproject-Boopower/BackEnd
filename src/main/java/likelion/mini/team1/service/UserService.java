...
public class UserService {
	...
	public void updateActivity1(UpdateActivity1 request) {
		Activity1 activity = activity1Repository.findByName(request.getActivityName())
		...
		activity1Repository.save(activity);
	}
